...
interface Scrap { id: string; user_id: string; scrap_date: string; news_date: string; title: string; link: string; newspaper: string; region: string; keywords: string; summary: string; translation: string; commentary: string }
...
export default function EditScrapPage() {
  ...
  const [form, setForm] = useState<Scrap>({
    ...
    newspaper: "", region: "", keywords: "", summary: "", translation: "", commentary: ""
  });
